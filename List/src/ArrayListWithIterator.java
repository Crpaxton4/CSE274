...
public class ArrayListWithIterator<T> implements ListWithIteratorInterface<T> {
	...
	public Iterator<T> getRevIterator() {
		return new RevIteratorForArrayList();
	}

	private class RevIteratorForArrayList implements Iterator<T> {
		private int nextIndex;
		private boolean wasNextCalled;

		private RevIteratorForArrayList() {
